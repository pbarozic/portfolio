    ...
    return (
      <footer className="bg-teal-900 py-4 px-6 text-white">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="flex">
          <a href="mailto:pierrebaptiste.rozic@gmail.com" className="lg:text-sm text-xs text-white hover:text-teal-600 mr-4">
          pierrebaptiste.rozic@gmail.com
          </a>
            <a href="https://github.com/pbarozic" target="_blank" rel="noopener noreferrer">
              <FaGithub className="text-white hover:text-teal-800 mr-2" size={24} />
            </a>
